...
- `skills/education/discover-github-projects` — evidence-backed GitHub project
  architecture, runtime, security, and intended-use deep dives.
- `tools/vidra` — SQLite-backed source and report registry plus the shared local
  catalog for video and GitHub project analyses.
